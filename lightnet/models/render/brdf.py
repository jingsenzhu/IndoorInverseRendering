...
def sample_ggx(sample: torch.Tensor, albedo: torch.Tensor, roughness: torch.Tensor, metallic: torch.Tensor, wi: torch.Tensor):
    """
    :param: sample (bn, spp, 3, h, w)
    ...
    weight = evalFresnel(specularF0, shadowedF90(specularF0), HdotL) * sample_weight_ggx(alpha*alpha, NdotL, NdotV) / kS.unsqueeze(1)
